...
import com.unicom.dao.ICoureDao;
...
@Service("coureService")
public class CoureServiceImpl implements CoureService {

	@Resource
	private ICoureDao studentDao;

	public List<Coure> getStuList(String stuName,int currPage, int pagesize) {
	...
	public void studentAdd(Coure stu) {
		studentDao.studentAdd(stu);
	}

	public Coure getStuById(String id) {
		return studentDao.getStuById(id);
	}

	public void studentUpdate(Coure stu) {
